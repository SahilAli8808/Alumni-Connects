            ...
            <div style={{width:'290px' , height:'600px'}}>
                <div className="card">
                    <div className="card-image">
                        ...
                        <image class="is-rounded" src="https://bulma.io/images/placeholders/1280x960.png" alt="Placeholder image"/>
                        </figure>
                    </div>
                    <div className="card-content">
                        <div className="media">
                            <div className="media-left">
                                ...
                                <image class="is-rounded" src="https://bulma.io/assets/images/placeholders/96x96.png" alt="Placeholder image"/>
                                </figure>
                            </div>
